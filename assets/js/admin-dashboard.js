...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!startButton || !countSpan || !progressBar || !statusDiv || typeof egMediaBulk === 'undefined') {
        return;
    }
    ...
    function processBatch() {
        ...
        .then(data => {
            if (!data.success) {
                const message = data.data && data.data.message ? data.data.message : "Une erreur est survenue.";
            ...
            if (remaining > 0 && processed > 0) {
                ...
                statusDiv.textContent = "Optimisation terminée avec succès ! Rechargement de la page...";
                setTimeout(function () {
